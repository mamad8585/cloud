...
VOLUNTARYCHECK=0
I=1
BOT=TeleCloud4  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
echo -e "               \e[01;34m            by Abolfazl Power              \e[00;37;40m"
echo ""
cat << EOF
